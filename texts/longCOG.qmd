...
![Interaction terms of the “test scores” (A) and the “factor scores” (B) models predicting post-surgery cognitive decline. Acronyms are explained in the text.](../figs/posterior_summaries.jpg){#fig-postsum width=100% height=83%}
...
rm( list = ls()[ !ls() %in% c("d","df") ] ) # clear environment
