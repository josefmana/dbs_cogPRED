...
![Patients inclusion/exclusion flowchart. The plot shows reasons for excluding patients from the total sample of 200 patients considered for subthalamic nucleus deep brain stimulation treatment.](../figs/inclusion_flowchart.png){#fig-flow}
```{r}
#| label: tabs-prep
