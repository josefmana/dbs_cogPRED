...
t4 <-
  ...
  tab_source_note(
    source_note = "Values represent posterior prediction median [90% equal tailed interval (ETI)]; Y[i]: assessment i years post-surgery. We used 90% ETI instead of the 95% highest density posterior predictive intervals (PPIs) used elsewhere in the article because 90% ETI can be interprated such that there is 5% probability of observing value smaller than its lower bound and 5% probability of observing value bigger than its higher bound which may not hold for PPIs."
  )
