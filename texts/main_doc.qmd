...
f5 <-
  ...
  mutate( `Generated by: ` = factor( `Generated by: `, levels = paste0( "Group-", c("level parameters"," & Patient-level parameters") ), ordered = T ) ) %>%
  ...
  scale_colour_manual( values = cbPal[c(8,1)] )
