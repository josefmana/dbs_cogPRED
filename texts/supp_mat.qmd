...
f1 <-
  ...
  lapply(
    ...
    function(i)
      ...
      t() %>%
      as.data.frame() %>%
      pivot_longer( everything() , names_to = "Model" , values_to = all_of(i) ) %>%
      rename( "index" = i ) %>%
