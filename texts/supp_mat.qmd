...
f3 <-
  ...
  geom_pointrange( data = contr, aes(xmin = eti_low_all, xmax = eti_hig_all), linewidth = 5, colour = cbPal[8], alpha = .4 ) +
  geom_pointrange( data = contr, aes(xmin = eti_low_random, xmax = eti_hig_random), linewidth = 5, colour = cbPal[8], alpha = .6 ) +
  geom_pointrange( data = contr, aes(xmin = eti_low_fixed, xmax = eti_hig_fixed), linewidth = 5, colour = cbPal[8], alpha = 1 ) +
